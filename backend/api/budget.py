...
Operator, 2026-08-15, on how a transition works:
...
LIFECYCLE AND BUDGET ARE ORTHOGONAL, and conflating them is the mistake this module exists to avoid:
    ...
    lifecycle (kumo-strategies `runtime/executor/lifecycle.py`)   MAY it act
...
def plan_distribution(
    ...
    and QC345-003 sat on 2026-08-19 while 44,889.50 sat unallocated.
