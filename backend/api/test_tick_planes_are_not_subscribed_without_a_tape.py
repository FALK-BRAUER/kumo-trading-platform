...
MEASURED on staging2, boot of 2026-09-09 05:36 UTC (engine jsonl, 7986 lines):
...
def test_a_provider_with_NO_TAPE_is_not_asked_for_trade_ticks():
    """staging2's case. 112 requests IB answers with 10189/10190 and never serves."""
...
def test_the_BARS_still_flow_when_both_tick_planes_are_refused():
    """THE THING THAT MUST NOT BREAK. staging2 trades off 1-MINUTE-LAST-EXTERNAL and
