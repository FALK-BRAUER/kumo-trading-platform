"""The doubles in test_market_aware_fold.py claim the shape of kumo-strategies' `Verdict` and
...
if not all(hasattr(mv, n) for n in ("YES", "NO", "UNKNOWN", "IN_ENVELOPE", "OUT_OF_ENVELOPE")):
    pytest.skip("installed kumo-strategies predates f5895d1 (three-state Verdict/Assessment, PR #156)",
