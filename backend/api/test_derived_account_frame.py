...
Measured on staging-ibkr: equity 999,200.54, cash 973,807.42, long_market_value 0.00 — while the
...
def test_the_fixture_is_the_staging_shape():
    ...
    frame = derived_account_frame(equity=999_200.54, cash=973_807.42, cash_ccy="SGD",
                                  standing=None, ts=1)
