...
So the `armed` probe exists on BOTH sides of the seam — kumo-strategies reports it in
...
kumo-strategies warned about: "if you see UNARMED on a trading morning, that is a real incident and not
a benign log line".
