...
WHAT HAPPENED, 2026-08-24, on ibkr-paper-retired. BCTROT-004 decided `enter 8` and all 8 died inside the
exec client:
...
WHY alpaca-paper CANNOT SHOW THIS: data and exec are both Alpaca there, so the instrument that priced
