...
MEASURED on paper 2026-08-31, and found only because a reviewer read the residual cache rather than
...
def test_a_PROTECTIVE_STOP_is_skipped_by_identity__a_reduce_only_lane_exit_is_NOT():
    ...
    pre-check needs a `position_id` strategies never pass — while kumo-strategies submits every lane
...
def test_the_REFUSAL_IS_LOUD_and_DENIES_the_order():
    ...
    (kumo-strategies#103 journals it as "rejected by the venue")."""
