...
def test_etf_auto_is_stable_two_part_id() -> None:
    """`ETF_AUTO-001` is the value out-of-tree backtest artifacts (kumo-strategies) already write into their
...
def test_gem_vt_is_not_a_strategy_id() -> None:
    """Provenance guard (#8 / kumo-strategies momentum-rotation plan): `GEM-VT` names the rotation MODEL,
