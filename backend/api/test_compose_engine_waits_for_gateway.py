...
WHAT HAPPENED. On a cold deploy of staging-ibkr the engine started immediately — its `depends_on`
...
def test_the_wait_is_NOT_REQUIRED_so_an_ALPACA_deploy_is_unaffected():
    ...
    assert dep.get("required") is False, (
        "the gateway dependency is REQUIRED. test-alpaca never starts ib-gateway (profiles: ibkr), "
