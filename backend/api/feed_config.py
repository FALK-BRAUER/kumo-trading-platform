...
# to the platform is what made `kumo-cockpit` un-runnable by anyone else.
#
...
def load_feed_config(path: Path = _CONFIG_PATH) -> FeedConfig:
    ...
    #
    # The cost was not cosmetic. staging-ibkr took Alpaca data, which built an `AlpacaHttpClient`,
