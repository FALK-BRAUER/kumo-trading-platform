...
The cause was mine — kumo-cockpit#498 parameterised two gates that the legacy `up-paper` path did not
...
def test_a_registered_lane_that_is_NOT_declared_trading_is_not_a_contradiction():
    ...
    DISABLED by design" — an absent row reads as TRADING (Operator, 2026-08-19) — and it cited
    MOMENTUM-002 on staging-ibkr as an example of running that way, when MOMENTUM-002 has an explicit
