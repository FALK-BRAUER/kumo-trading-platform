...
def test_a_RECONSTRUCTION_must_MEASURE_its_attribution_rather_than_be_given_a_constant():
    """THIS TEST USED TO PIN THE DEFECT AS DELIBERATE, which is the kumo-strategies falsy-`or`
...
def test_the_ON_CONFLICT_predicate_contains_NO_BIND_PARAMETERS():
    """MEASURED ON A REAL POSTGRES, then pinned here so it can never come back offline.
