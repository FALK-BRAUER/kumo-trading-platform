...
THE CRASH, staging-ibkr 2026-08-29 02:45 SGT:
...
def test_the_constructor_really_does_NOT_accept_claimed_symbols():
    """FIXTURE PROPERTY FIRST. If kumo-strategies had since added `claimed_symbols`, this whole file
    ...
    assert "claimed_symbols" not in params, (
        "kumo-strategies now accepts claimed_symbols — reconsider whether claims can be lazy, and "
