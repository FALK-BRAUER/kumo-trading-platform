...
— and `providers/alpaca` is the only exec client this repo owns. ibkr-paper-retired runs the SHIPPED
...
async def budget_allows(order, *, cache, book_loader, log, price_of=None, journal=None,
    ...
    cache was priced at 0.0, checked at notional 0, and ALLOWED — on ibkr-paper (IBKR, no quote lines
