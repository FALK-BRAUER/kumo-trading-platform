...
def domains() -> list[str]:
    ...
    A strategy's parameters are generated from its kumo-strategies config dataclass rather than kept
    ...
    if path.exists():
        try:
            ...
            if isinstance(loaded, dict):
                ...
                # in silence, which is the more likely mistake — test-alpaca's notifications file has
