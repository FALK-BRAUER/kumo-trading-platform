...
# produced out-of-tree in `kumo-trading-strategies` (backtest artifacts, decision/order/fill tables) can carry the
...
# QC27 Tech Momentum with Inverse Volatility (issue 33, #63). The wire id is the STRATEGY
