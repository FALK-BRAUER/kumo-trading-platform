...
"No account history yet" over an account holding $1,001,292 with months of history.

`Account.events -> list[AccountState]` is the native, provider-agnostic source, and Nautilus persists
it. Measured 2026-08-26: 284,398 events on paper, 22,007 on staging. The IBKR curve was in the cache
