...
MEASURED on ibkr-paper (IBKR), 2026-09-09, boot at 14:03:40 UTC — all inside ONE SECOND:
...
WHAT THE LANES NEED. Their warmup calls come from the pinned kumo-trading-strategies runners
...
class _Lane:
    """A kumo-trading-strategies runner as cockpit sees it: an object with its own bound request methods."""
...
def test_lane_requests_carry_NO_join_request_because_nautilus_parks_joined_legs():
    """MEASURED on ibkr-paper, boot 15:45Z 2026-09-09: 173 lane warmup requests issued through the queue
...
def test_the_DISPLAY_hold_does_not_park_held_positions_or_lane_warmups():
    ...
    warmups. MEASURED on ibkr-paper at the 14:47Z boot on 2026-09-09: hold 900, and NOTHING left
