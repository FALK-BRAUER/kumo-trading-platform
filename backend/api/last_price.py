...
kumo-trading-strategies exposes `last_price_from_cache(cache, instrument_id, …)` (asked of l21wvpmj; the
...
#: The follow-up that deletes this module: kumo-trading-strategies exposing `last_price_from_cache`.
FOLLOW_UP = "kumo-trading-platform issue 990 (follow-up: import `last_price_from_cache` from kumo_strategies, delete this mirror and its pin)"
