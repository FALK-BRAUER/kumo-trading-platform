...
MEASURED ON PAPER, 2026-08-31, from the running engine's own health frame:
...
the broker fallback a paper instance gets (`AlpacaCalendar`, from kumo-strategies) exposes
