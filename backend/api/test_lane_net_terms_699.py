...
def test_IBKR_PAPER_BOOT_PAIRS_are_vouch_NEUTRAL_named_and_MOMENTUM_stays_numeric():
    """ibkr-paper /orders, 2026-09-11 12:08 ET: IB reconciliation at boot wrote, per held name, a SELL on
...
def test_IBKR_PAPER_EXTERNAL_BOOT_MIRRORS_do_NOT_refuse_the_lane_whose_position_they_mirror():
    """ibkr-paper 09-11 12:08:17 ET (fr2467iv's table): per name, EXTERNAL BUY tagged VENUE at the
