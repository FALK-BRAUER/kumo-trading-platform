...
WHAT REACHES THE UI FROM ibkr-paper-retired, whose Nautilus object is unambiguous:

    AccountState(account_id=INTERACTIVE_BROKERS-DUPTEST02, base_currency=None,
                 balances=[AccountBalance(total=1_000_000.00 SGD, ...)])
...
kumo-trading-strategies' caution, which bounds what this closes: a currency field that nothing COMPARES is a
