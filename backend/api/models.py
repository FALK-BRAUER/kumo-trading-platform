...
class SubsystemHealth(BaseModel):
    ...
    #: a positive verdict manufactured out of no information. Measured on paper 2026-09-11 00:34, that
...
class HealthResponse(BaseModel):
    ...
    #: notifications off could not look. staging2 stood at eleven divergent pairs and 1,504 shares,
...
class AccountDTO(BaseModel):
    ...
    #: THE UNIT (#518). `AccountDTO` published bare floats, and on staging-ibkr that meant 999,215.19
