...
MEASURED on staging 2026-08-29, after #622 made `load_contracts` declare the full universe:
...
kumo-strategies does not install — and "ARCA" is not "ARCX", so a naive `primaryExchange == venue`
