...
THE DEFECT, measured on ibkr-paper-retired 2026-08-27: XLU/XLRE/XLP were not in the IBKR instrument
...
def test_one_never_arriving_symbol_does_not_hold_the_compass_dark():
    ...
    exactly the loop measured on an IBKR paper instance — `short` never empties, `build_payload` never runs."""
    host = _host()
