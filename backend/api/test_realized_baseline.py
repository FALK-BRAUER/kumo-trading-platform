...
disabled the check. On any account that did not start at exactly $100,000 (staging-ibkr starts in
...
(kumo-cockpit-instances owns that; paper must set ACCOUNT_BASELINE_EQUITY=100000 to keep it armed).
