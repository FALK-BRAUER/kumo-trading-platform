...
# completely, including the flip cases the rationale cites, and kumo-strategies' own tests are the
...
#
# Removed from REQUIRED here FIRST; kumo-strategies drops the Protocol member and the mixin behind it,
