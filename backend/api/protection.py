...
#:                60-session periods (kumo-strategies#139) at -10.7pp against the trail's -82.5pp for
...
def lane_quantities(cache_positions) -> dict[tuple[str, str], dict[str, float]]:
    ...
    which refuses a multi-holder instrument outright. Measured on paper 2026-09-08: CRAK, LAND, PAGP
...
class WrongMode:
    ...
    latency (~4 s measured on paper 2026-09-10), one leg across the whole book at a time — the engine
