...
def test_the_venues_stop_price_is_cached_so_SECURED_can_be_computed(monkeypatch):
    ...
    Measured on a live instance book: FIG stop 25.5505 hwm 26.2057, SMH stop 553.865 hwm 589.72 — the venue has
    it, we did not.
    """
    _settings(monkeypatch)
...
def test_an_instrument_TWO_LANES_hold_gets_ONE_STOP_PER_LANE(monkeypatch):
    ...
    What the refusal cost, measured on an Alpaca paper instance 2026-09-08: CRAK, LAND, PAGP and GMAB each had one
