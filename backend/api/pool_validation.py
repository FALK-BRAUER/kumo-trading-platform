...
Measured on paper 2026-08-29: nine of 117 pool symbols never resolve — BLLLN, BOX, DBX, GEN,
...
def _likely_twin(symbol: str, known: set[str], _pool: set[str]) -> str | None:
    ...
    # answer. Measured on the real catalog, 4,000 valid tickers removed one at a time — and stated
