...
def test_an_UNMARKED_series_is_left_exactly_as_it_was():
    ...
    states = [_State(total=999_491.28, ts_s=now - 900, free=974_041.11, currency="SGD"),
              _State(total=999_200.54, ts_s=now - 60, free=973_807.42, currency="SGD")]
...
# ==================================================================================================
# UNCLAIMED MUST BE INSIDE EQUITY (Operator, 2026-08-27: "if calculated from nautilus, need to handle
# unclaimed properly")
#
