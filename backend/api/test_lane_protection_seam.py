...
# ---------------------------------------------------------------------------------------------
# (n) THE FLIP WINDOW (#898). Measured on an Alpaca paper instance 2026-09-10: `type` is not patchable and `stop_price`
...
def test_a_CRSISHORT_short_row_is_lane_unattributable_whatever_the_stance_says_TODAY(monkeypatch):
    ...
    row from Monday 13:20Z on ibkr-paper is the plane's long-only defect, ticketed separately, and NOT
