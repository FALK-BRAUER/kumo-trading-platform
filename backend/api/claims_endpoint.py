...
The predicate itself is kumo-trading-strategies' `over_claimed`, reached through `api.claims_invariant`. Not
...
def build_breaches(rows, account: dict | None) -> Breaches:
    ...
    #
    # THE THIRD STATE (#903): a kumo-trading-strategies pin without the predicates. Named here, at the one
