...
MEASURED on an IBKR paper instance 2026-08-29, after #622 made `load_contracts` declare the full universe: 64 of
...
WHY HERE AND NOT IN THE RESOLVER. `exchange_to_mic_venue` needs `ibapi`, which kumo-trading-strategies does
