...
async def distribute_unallocated(
    ...
    position — while $45,000.00 sat unallocated and BCTROT's close-20m slot was two hours out.
...
async def lifecycle_states(session) -> dict[str, str]:
    ...
    an absent row means TRADING (2026-08-19) and that default belongs to the CALLER, stated,
