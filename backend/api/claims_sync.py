...
or None)`; the quantity is SIGNED — kumo-trading-strategies `contract.py:231` hands
...
ZERO IS FLAT, AND NOTHING ELSE IS. The sign is carried through unchanged; issue 178 stores
