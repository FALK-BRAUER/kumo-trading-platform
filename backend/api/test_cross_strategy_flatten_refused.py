...
THAT ROUTE NOW EXISTS (issue 49, #374). `register_strategy` records the sibling INSTANCE and the
...
def test_a_position_whose_OWNER_IS_REGISTERED_is_routed_rather_than_refused():
    """The capability, not just the guard (issue 49).
    ...
    # flattening one name would dump the other five. issue 49 proposed it; it is the wrong
