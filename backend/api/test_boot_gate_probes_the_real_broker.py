...
def test_retries_while_degraded_are_BOUNDED():
    ...
    Measured on an Alpaca paper instance 2026-08-25: the same four PREFLIGHT DEGRADED lines repeated continuously. An
...
def test_the_broker_is_found_by_CAPABILITY_not_by_attribute_name():
    """MEASURED ON AN ALPACA PAPER INSTANCE, 2026-08-25 10:14:21, with the name-based fix DEPLOYED:
