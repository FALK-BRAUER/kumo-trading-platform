...
against an entry-relative floor's 10.7pp (issue 139). The operator approved exempting QC345-003.
...
def test_the_two_modes_disagree_on_every_name_in_tonights_QC345_book():
    ...
    swept `PortfolioConfig` flags had in kumo-trading-strategies."""
