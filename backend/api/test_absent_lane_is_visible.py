...
WHAT HAPPENED, test-alpaca 2026-08-25. QC345-003's build-time universe fetch timed out.
...
def test_a_NON_TRANSPORT_failure_still_propagates():
    """#377's separation by TYPE must survive. Misconfiguration crashes the node deliberately: a lane
    the operator switched on and that is silently absent is the worse outcome."""
