...
def test_a_CLOSED_position_is_never_planned_against():
    ...
    Measured on a live instance cache before this was written, not imagined."""
...
# --------------------------------------------------------------------------------------------
#
# MEASURED ON AN ALPACA PAPER INSTANCE 2026-09-01: four clean minted pairs (MRVL, RBRK, TOST, VEEV) — lane long and
...
# --------------------------------------------------------------------------------------------
#
# MEASURED ON AN ALPACA PAPER INSTANCE 2026-09-01. CGAU.XNYS: BCTROT-004 +168, MOMENTUM-002 -88, EXTERNAL -80, all at
