...
calls the same writer with no HTTP hop, and is therefore unguarded. Measured on paper 2026-08-29,
`george_book` refreshed at 10:32 — an hour after #663 deployed — still carrying BLLLN, IQVIA, JEPO
and OVVI.
