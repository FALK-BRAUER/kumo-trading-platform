...
Measured on ibkr-paper 2026-09-10 12:50Z: 15 names code 3.0 with shares (SOUN the smallest at 38,594),
...
# what left the build_node → attach → borrow_rates import unchecked on ibkr-paper's 0fbcfff pin
...
needs_crsishort = pytest.mark.skipif(
    ...
    reason="reads upstream LOCATABLE — installed kumo-trading-strategies has no CRSISHORT adapter")
...
def test_the_provider_answers_LOCATABLE_None_and_never_and_NEVER_a_number():
    """LOCATABLE is identity (kumo-trading-strategies 7bf2a2c): `borrow[sym] is LOCATABLE`. A 0.0 would
