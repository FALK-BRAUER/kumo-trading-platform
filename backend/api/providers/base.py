...
class DataClientSpec:
    ...
    #: rationed EVERY provider: staging-ibkr denied 87 symbols live data against a competitor's pricing
    ...
    #:
    #: MEASURED, staging2 boot 2026-09-09 05:36 UTC: `_after_definition` subscribed BOTH planes for
