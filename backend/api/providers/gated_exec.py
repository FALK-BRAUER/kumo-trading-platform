...
def install_ownership_gate(client, *, log=None):
    ...
    WHAT IS NOT ASKED, and why each:
      ...
      * A PROTECTIVE STOP, BY IDENTITY (`PROTECTION_COID_PREFIX`), NOT BY `is_reduce_only`. #748's
        ...
        flag is dropped at the adapter. kumo-trading-strategies submits EVERY lane exit and cover
    ...
    asked (issue 103 journals Rejected as "rejected by the venue"). The consumer treats
