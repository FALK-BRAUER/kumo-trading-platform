...
MEASURED on ibkr-paper over 22h (2026-09-02T16:22Z to 2026-09-03T14:53Z): IB account DUPTEST02 held
...
(`client/order.py:138`). It defaults to False, this repo does not set it, and ibkr-paper saw all 18
...
def _report(reporters, account_id, skipped):
    ...
    if skipped and changed:
        # ERROR ONLY WHEN THE SET CHANGES. This runs on every reconciliation tick (~6s on ibkr-paper),
