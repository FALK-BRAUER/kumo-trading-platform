...
WHY total AND NOT SOMETHING ELSE. Measured 2026-08-27:
  ...
  - `Portfolio.equity()` is called NOWHERE in this repo or in the pinned kumo-strategies, so its
...
def test_a_NON_FINITE_equity_is_refused_not_compared(poison):
    ...
    kumo-strategies 43c6d3e is the same bug in the other direction: `broker_equity` returned NaN and
