...
disagree, so it could not detect anything. Measured on paper 2026-08-27, all five periods rendered
...
def test_a_NON_FINITE_value_makes_the_total_unknown(poison):
    ...
    daily-loss halt in kumo-strategies 43c6d3e, and that reached this repo again in #588."""
