...
def test_alpacas_own_account_fields_are_internally_consistent():
    """The premise, stated so it is checked rather than assumed. Measured on the live paper account
...
def test_the_account_snapshot_carries_last_equity_so_the_ui_can_show_net_for_1d():
    ...
    DEFAULT tab is derived from `equity - last_equity` — Alpaca's own day P&L. Measured on the live
