"""The shortable plane must attach on a kumo-trading-strategies pin that has NO CRSISHORT module.

Measured on the codex merged-result review of main 87b173f (2026-09-10 20:05Z), then read: ibkr-paper
pins kumo-trading-strategies 0fbcfff, which predates `kumo_strategies.strategies.crsi_short`. IBKR always
