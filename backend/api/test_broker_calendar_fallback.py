...
I FIRST WROTE A SECOND ALPACA CALENDAR. That was wrong, and review found it: kumo-strategies already
...
def test_a_broker_calendar_is_returned_when_the_credentials_are_there(monkeypatch):
    """On paper this is `AlpacaCalendar` — the one kumo-strategies already ships and
