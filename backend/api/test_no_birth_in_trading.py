...
def test_the_trigger_fires_on_INSERT_ONLY():
    ...
    The operator rejected SHADOW outright, and the real gate is now kumo-strategies' boot-time dry_run. A
...
def test_NOTHING_IN_THE_REPO_CLAIMS_AN_ABSENT_LIFECYCLE_ROW_IS_DISABLED():
    ...
    An absent row reads as TRADING (Operator, 2026-08-19, `momentum._lifecycle`). Six places said the
    ...
    wrong, because it survives review by sounding careful — staging-ibkr's runbook stated this same
