...
WHY "CANCEL ONLY YOUR OWN" IS WRONG. Measured on a live instance durable cache 2026-08-22, nine of ten
...
def may_cancel(*, owner: str | None, canceller: str) -> bool:
    ...
    UNATTRIBUTABLE IS REFUSED. Cockpit's ids are `PROT-SELL-{SYMBOL}-{hash}` and kumo-trading-strategies' are
...
def may_cancel_order(*, owner: str | None, canceller: str, row: dict,
    ...
    #
    # Without this, the rule refused the only stop resting on the live book: PROT-SELL-BDX-XNYS-00000002,
