...
Measured on an Alpaca paper instance 2026-08-29, both lanes, unchanged for two days:
...
def test_THE_TWIN_FINDER_AGAINST_A_REALISTIC_NAMESPACE():
    ...
    neighbours everywhere. Measured on a live instance catalog, those families were nearly the whole
...
def test_THE_REFRESH_ENDPOINT_DROPS_THE_BAD_AND_REPORTS_IT(monkeypatch):
    ...
    asyncio.run(app_mod.refresh_pool_source("ledger_book", _Body()))
