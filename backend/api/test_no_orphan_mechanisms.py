...
ALLOWED = {
    "build_on_emergency_exit": "#922 — the callback target kumo-strategies' emergency exit calls "
    ...
    "claim_conflicts": "multi-strategy claim detector — REDUNDANT with kumo-strategies' "
...
def test_the_scan_can_actually_find_an_orphan() -> None:
    ...
    exactly how the truncation-invariance test in kumo-strategies passed twice with the bug in."""
