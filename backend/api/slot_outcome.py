...
MEASURED ON THE LIVE JOURNAL, all strategies, since 2026-07-31:
...
def fold_slot_rows(rows) -> dict[tuple[str, str, str], SlotCounts]:
    ...
    #     carries a 07:15 george_book refresh failure ahead of a 13:35 decision, and charging that to
    ...
    for r in rows or ():
        ...
        if kind == "decision":
            ...
            # coid keying; `record_terminal` (kumo-strategies pgrunner.py) writes
