...
def test_resting_exit_orders_are_CANCELLED_not_a_reason_to_refuse():
    ...
    operator unable to exit their own position — 2026-08-13, on WDAY: "I cannot even flatten it."
...
def test_the_engine_cancels_resting_exits_and_waits_before_closing():
    """2026-08-13, on WDAY: "I cannot even flatten it." The decision now says cancel-first; this
