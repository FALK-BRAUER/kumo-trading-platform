...
WHY. Measured on a live instance journal, all strategies, since 2026-07-31:
...
# ==================================================================================================
# THE SLOT COLUMN LIES ON ORDER ROWS (found 2026-08-22 by the kumo-trading-platform-ibkr session).
#
...
#
# MEASURED on an IBKR paper instance's own journal, BCTROT-004 / 2026-08-24 / open+215m, by running `fold_slot_rows`
