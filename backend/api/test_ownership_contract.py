...
* **Scoped PER FUNCTION, never per module.** kumo-strategies' first attempt at the matching rule was
...
def test_the_exemption_names_a_function_that_ACTUALLY_sets_reduce_only():
    ...
    same shape as kumo-strategies' truncation test that passed twice with the bug reintroduced."""
