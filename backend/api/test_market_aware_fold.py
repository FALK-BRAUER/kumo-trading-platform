...
The doubles carry the shape kumo-strategies f5895d1 gives `Verdict`/`Assessment`: `.state`, `.acts`,
...
# -- doubles: the shape of kumo-strategies f5895d1, and they CAN say unknown -------------------------
