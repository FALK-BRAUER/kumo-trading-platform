...
Measured on ibkr-paper (IBKR, cockpit aeed851), 2026-09-11: "budget gate INSTALLED on
...
def test_a_FLIP_that_GROWS_exposure_is_an_ENTRY_and_priceless_is_refused_a_flip_that_SHRINKS_is_exempt():
    """(3d) The predicate is upstream's ONE rule (`budget_gate.is_entry`, kumo-trading-strategies #39, pinned
