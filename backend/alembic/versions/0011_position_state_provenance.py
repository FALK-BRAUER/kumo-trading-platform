...
def _table_exists() -> bool:
    ...
    IT IS NOT OURS. `exec_position_state` is declared by kumo-trading-strategies
...
def upgrade() -> None:
    if not _table_exists():
        # Fresh database: kumo-trading-strategies' `create_all` will build the table WITH these columns,
        ...
        print(f"alembic 0011: {_TABLE} does not exist yet — kumo-trading-strategies' create_all owns it and "
