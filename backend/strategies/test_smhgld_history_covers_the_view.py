...
bars: measured on paper 2026-09-12, a boot at 10:03:56Z requested `start=2026-08-13` for both legs,
...
has not declared. Read off the INSTALLED kumo-strategies config, so a change to either side of the
...
def _upstream_or_skip():
    ...
    try:
        ...
        pytest.skip("installed kumo-strategies predates the SMHGLD sleeve adapter (ks#177)")
