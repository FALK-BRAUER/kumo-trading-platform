...
SIGNED (kumo-strategies `contract.py:231`; driven 2026-09-11: `protective_close` with a -1234 short
...
def _store_represents_short() -> bool:
    """kumo-strategies#178's capability constant — the ONE authority on whether the ledger takes a
...
@pytest.mark.xfail(not _store_represents_short(), strict=True,
                   reason="the installed store predates kumo-strategies#178 and REFUSES a negative claim "
