...
Operator, 2026-09-08: "It is 1.0. In reality it is lower because of math, but only in reality, not per
...
def test_the_default_is_not_the_value_we_set_so_these_tests_can_fail():
    ...
    assert default != 1.0, (
        f"installed kumo-strategies default is already {default!r}; these tests can no longer "
