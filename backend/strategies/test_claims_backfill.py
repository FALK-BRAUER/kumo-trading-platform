...
Measured on paper 2026-08-29: QC345-003 held 5 positions (AMAT 6, DELL 7, INTC 37, LRCX 10,
...
(kumo-cockpit#197 B1): seeding an adopted position from the current price asserts a peak that never
...
# ==================================================================================================
# THE DELETE-RACE (kumo-cockpit#845, codex scope review): adoption must decide under the key's lock
# ==================================================================================================
...
def test_a_STALLED_claim_write_is_named_in_the_result_not_swallowed_into_a_warning(monkeypatch):
    """`store.write_claim` (kumo-strategies f54f54d) raises `ClaimWriteStalled` after 30 s — a class
