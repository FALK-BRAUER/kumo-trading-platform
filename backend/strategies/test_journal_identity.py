...
The live risk, before kumo-strategies fixed their half: MOMENTUM-002 decides at `open+5m`; BCTROT-004's
...
reads as TRADING (Operator, 2026-08-19), so the containment described here never existed. **Arming BCTROT-004 removes that containment as step one**, which is why this
blocks #320.
