...
THE FAILURE, measured twice on staging-ibkr — 2026-08-27 18:38 SGT and 2026-08-28 06:20 SGT:
...
def test_NO_strategy_module_hardcodes_a_vendor_URL_or_credential():
    ...
    lanes layer: on staging-ibkr (no Alpaca credential, by design) the assets frame was None and
