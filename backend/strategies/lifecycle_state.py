...
It matters because of the default it collides with: an absent row reads as TRADING (Operator, 2026-08-19,
...
Not hypothetical: on staging-ibkr today, `exec_strategy_state` holds two rows while the node registers
