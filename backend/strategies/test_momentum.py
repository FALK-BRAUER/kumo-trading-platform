...
#
#   kumo-trading-strategies  tests/runtime/nautilus/test_symbols_resolve_through_nautilus.py
...
#
#   kumo-trading-strategies  test_resolving_NOTHING_does_not_take_the_node_down
#
...
def test_bctrot_registers_inert_and_claims_nothing(monkeypatch):
    """BCTROT-004 alongside MOMENTUM-002 (issue 32, the operator 2026-08-16).
