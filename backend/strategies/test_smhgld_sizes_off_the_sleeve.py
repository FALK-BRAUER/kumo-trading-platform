"""SMHGLD sizes its targets off ITS SLEEVE, never off the account (platform issue 986).
...
Alpaca `portfolio_value`, or IB net liquidation in the account's BASE currency (SGD on ibkr-paper) — and
...
def _upstream():
    try:
        ...
        pytest.skip("installed kumo-trading-strategies predates the SMHGLD sleeve (06f3055)")
