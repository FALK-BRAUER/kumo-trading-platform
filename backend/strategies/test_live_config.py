...
are silently ignored by the thing holding real positions (kumo-trading-platform issue 197 B12). kumo-trading-strategies has
...
def test_the_deployed_config_asks_for_no_exit_rule_live_ignores():
    ...
    assert unsupported == [], (
        ...
        f"implement. Either implement it live and add it to LIVE_SUPPORTED_EXITS in kumo-trading-strategies, "
