...
kumo-strategies' own docstring predicted this exact outcome before it happened: *"a live book of 2 names
...
def test_the_installed_risklimits_actually_has_the_field():
    ...
    assert "allocated_equity" in RiskLimits.__dataclass_fields__, (
        ...
        "account, and pyproject.toml pins kumo-strategies by URL with no revision to enforce otherwise"
    )
