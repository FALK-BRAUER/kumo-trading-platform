...
ks#221 step 2: sell-in-strength at 4.5 ATR. The kumo-trading-strategies runtime already honours it —
...
# A SEAM FILE: every test reads kumo-trading-strategies. Under the merge gate's pin run the import must
