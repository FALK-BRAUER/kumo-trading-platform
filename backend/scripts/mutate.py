...
that was hit twice on 2026-08-22 in kumo-trading-strategies and nearly cost two real guards:
...
def apply_mutation(path: pathlib.Path, anchor: str, replacement: str) -> str:
    ...
    # protection against the second kumo-trading-strategies case and provide none.
    #
