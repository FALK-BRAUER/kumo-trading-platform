 ...
 *
 * `broker.equity_curve` has exactly one publisher — the Alpaca exec client. On staging-ibkr nothing
 * ever writes the topic, so the tile drew "No account history yet" over an account holding
 * $1,001,292 with months of history. True of a fresh Alpaca account; false here.
 *
