...
describe("the per-lane cells switch against THIS LANE'S SLEEVE (#586)", () => {
  // 2026-09-06: "still no % on strategies." The panel figures switched and the lane cells did
  ...
  it("renders `—`, never a number, when the lane has NO sleeve to divide by", () => {
    ...
    // reachable (every `actual` on alpaca-paper read 0 on 2026-09-05 while `target` read 20,000).
    host.unit = "%";
