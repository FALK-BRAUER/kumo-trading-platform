/**
 * Wilder's ADX / +DI / -DI (Average Directional Index), ported from predecessor-repo's proven
 ...
 * textbook 14) is ledger-provider's deliberate choice, confirmed in both the playbook doc and
 * predecessor-repo's default.
 *
