...
export interface components {
    schemas: {
        ...
        HealthResponse: {
            ...
            lanes_bleeding?: components["schemas"]["LanesBleedingDTO"] | null;
            /** Realized Legs */
            realized_legs?: {
                [key: string]: unknown;
            } | null;
        ...
        /**
         * LaneBleedDTO
         * @description One lane going to cash under a TRADING label (#1098): NO DECISION for `no_decision_sessions`
        ...
        LaneBleedDTO: {
            ...
            venue_exits: number;
            /** Own Entries */
            own_entries: number | null;
            /** No Decision Sessions */
            no_decision_sessions: number;
            /** Since */
            since: string;
            /** Blocked */
            blocked: string;
        ...
        /**
         * LanesBleedingDTO
         * @description THREE STATES (#1098, lead's scope): `lanes == []` with `status == "ok"` means the journal was
        ...
        LanesBleedingDTO: {
            ...
            status: string;
            /** Lanes */
            lanes?: components["schemas"]["LaneBleedDTO"][] | null;
            /** Error */
            error?: string | null;
        };
        /**
