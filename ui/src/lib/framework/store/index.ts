...
interface CockpitStore {
   ...
   *
   * 2026-08-16: the BOOK tile mixed three time bases with nothing saying so — DEPLOYED/CASH are
   ...
   *
   * The second axis of the same question the period selector asks. 2026-09-06: the toggle
   ...
   *
   * 2026-08-17, after a flatten that WORKED: "there was no proper feedback on flatten. The stock
   * looked unchanged."
   *
