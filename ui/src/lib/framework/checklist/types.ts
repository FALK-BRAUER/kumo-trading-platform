 ...
 *  methodology (George's Blue Flag, or any future one); those live entirely in `@/config/checklists.ts`. */
...
/** A named, registrable checklist definition — e.g. George's 8-condition Blue Flag is ONE `ChecklistDef`,
...
export interface ChecklistDef {
   ...
   *  function can inspect a SPECIFIC condition when needed (code review, #181: kumo-trader's tier branches
