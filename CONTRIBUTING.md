...
6. **PR through the merge gate.** `backend/scripts/merge_gate.py <pr>` (cockpit) or the CI check of the
   same name is the required status. It refuses a stale head, a red suite, and a head that moved after
