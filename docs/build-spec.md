...
> **BLOCKED — do not build as specified.** kumo-strategies' fourth reviewer found a deadlock in this
...
>
> **Second design input, found 2026-08-19 (kumo-strategies):** the ledger must distinguish a fill that
...
**Owner:** kumo-strategies (ks#51) · **Evidence:** `exec_action_log` 2026-08-14,
...
> Scoped and agreed with kumo-strategies; both sides verified the diagnosis independently.
...
**The shares were never missing.** `long_market_value 74,638.76` from the broker, FSM 933 and VCTR 88
...
(`trading/strategy.pyx:865-868`) — the defect kumo-strategies found in their own `#51`. Their
