...
## AMENDMENT — service tiers, adaptive cadence, and a capability banner (2026-08-28 03:07)
...
- Restoring the open+300m/open+315m slot timings (kumo-trading-strategies says not backtested; the operator decides).
